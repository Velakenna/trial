...
def generate_animation(effect):
  ...
  animation_frames.extend(animation)  # Append animation to frames list
  return animation_frames

# Command to start the bot
@app.on_message(filters.command("magic"))
def magic(client, message):
  print("Magic command triggered")
...
def button_click(client, callback_query):
    print("Button click callback triggered.")
    ...
    for frame in animation_frames:
        ...
        time.sleep(frame["duration"])  # Introduce delay between frames
